  ...
  <body role="document">
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="jumbotron">
        ...
        <p>Hier zie je een overzicht van de client met het ip: <?php 
echo "$ip $mac $username"; ?>. Je kan op een SSID klikken voor alle clients verbonden met deze SSID of op de AP voor alle clients verbonden met deze AP.<br/> Als de pagina leeg is wilt dit zeggen dat dit IP momenteel niet in gebruik is.</p>
