...
<html lang="en">
  <head>
    ...
    <title>Overview voor <?php $ap = $_GET["AP"];
echo "$ap"; ?></title>
...
echo "$ap"; ?>. Je kan op een IP klikken voor meer info te krijgen over deze client of op de SSID voor alle clients verbonden met deze SSID.</p>
		...
		<nav>
  <ul class="pager">
    <li class="previous"><a href="overviewaps.php"><span aria-hidden="true">&larr;</span> Ga terug naar het overzicht van de APs!</a></li>
  </ul>
</nav>
