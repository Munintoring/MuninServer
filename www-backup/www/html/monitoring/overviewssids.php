...
<html lang="en">
  <head>
    ...
    <title>Overview for all SSIDS.</title>
...
exec('/etc/scripts/ToonOverzichtSSIDs',$output);
...
<div class="jumbotron">
<h3><a href='http://193.191.187.33/munin/WLC/WLC/snmp_wlc_users_ssid_count.html'>Bekijk de grafieken van de SSIDs hier!</a></h3>
</div>
    </div> <!-- /container -->
